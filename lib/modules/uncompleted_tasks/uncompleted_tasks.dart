        ...
        return ListView.builder(
          itemBuilder: (context, index) {
            return buildTaskItem(
                AppCubit.get(context).tasks.where((element) =>element.completed==0).toList()[index],context);
            //else return Container();
          },
          itemCount: AppCubit.get(context).tasks.where((element) =>element.completed==0).toList().length,
        );
